// MERGED: PoolTable.jsx (locked cobalt board) + mobile gameplay UI.
// Co-located in one babel script (babel-standalone was skipping the standalone
// PoolTable.jsx in this bundle). Edit PoolTable.jsx + the UI block, then re-merge.
