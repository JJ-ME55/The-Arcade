// MERGED: PoolTable.jsx (locked cobalt board) + SidePocketGameUI.jsx (desktop match).
// Co-located in one babel script (babel-standalone skips the standalone PoolTable.jsx
// in these bundles). Edit PoolTable.jsx + SidePocketGameUI.jsx, then re-merge.
